...
from .views import ListArticlFields, ListPublications, ListDetails, ListFavoriteArticles, SignUpView, PublishView, AddToFavorites
...
urlpatterns = [
    ...
    path('details/<int:pk>/favorite', AddToFavorites.as_view(), name='addtofavorite')
]
